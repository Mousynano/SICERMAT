      ...
      <div class="container dashboard-container" id="punch-training">
         ...
         <div class="row cards-container">
            ...
            <div class="col-md-3">
               <div class="card carddata">
                  <div class="card-body">
                     ...
                     <canvas id="punchPowerGauge" class="mt-4 max-w-[260px] " height="165" width="365"></canvas>
                  </div>
               </div>
            </div>
            ...
            <div class="col-md-3">
               <div class="card carddata">
                  <div class="card-body">
                     <h5 class="card-title text-red-300">Retraction Time</h5>
                     <h5 id="retractionTime" class="card-text">0</h5>
                     <canvas id="retractionTimeGauge" class="mt-4 max-w-[260px] w-[255px]" height="165"
                        width="365"></canvas>
                  </div>
               </div>
            </div>
